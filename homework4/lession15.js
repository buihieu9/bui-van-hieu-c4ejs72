...
console.log( a['hits'][0].jobTitle)
console.log( a['hits'][0]['benefits'])
console.log('firt job hit benefit : ')
for(let i = 0; i < a['hits'][0]['benefits'].length; i++){
    console.log('-'+
        a['hits'][0]['benefits'][i].benefitValue
    )
}

for(let i = 0;i< a['hits'].length; i++){
    console.log(a['hits'][i].jobTitle)
    // console.log(a['hits'][i].locations[0])
    for(let j = 0; j < a['hits'][0]['benefits'].length; j++){
        console.log(a['hits'][0]['benefits'][j].benefitValue)
    }
    console.log('---------------------------------------------------------')
}


for(var v =0; v < a.hits.length; v++)
    {
        console.log(`Title: ${a.hits[v].jobTitle}`)
        console.log('Bennefits:')
        for(let i =0; i< a.hits[v].benefits.length;i++)
        {
            console.log(a.hits[v].benefits[i].benefitValue)
        }
        console.log('Skills:')
        for(let i =0; i< a.hits[v].skills.length;i++)
        {
            console.log(`- ${a.hits[v].skills[i]}`)
        }
        console.log(`Salary: ${a.hits[v].jobSalary}`)
